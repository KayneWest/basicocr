...
def ffunc(x):
    ...
    "709 at point where 'inf' needs to be clipped"
    return 1.0/(1.0+numpy.exp(-x))
    #return numpy.minimum(20,numpy.maximum(0,x))
...
class LSTM(Network):
    ...
    def forward(self,xs):
        ...
        self.last_n = n
        N = len(self.gi)
        #if n>N: raise ocrolib.RecognitionError("input too large for LSTM model") #TODO
        self.reset(n)
